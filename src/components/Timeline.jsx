...
export const Timeline = ({ data }) => {
  ...
  return (
    <div
      className="container mx-auto bg-black/40 mask-t-from-90% mask-b-from-90% max-w-full pb-10 md:pb-30 md:px-8"
      ref={containerRef}
    >
      <div className="max-w-7xl mx-auto pt-15 pb-15 px-4 md:pb-0">
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              ...
              <h3 className="hidden md:block text-xl md:pl-20 md:text-3xl font-bold text-neutral-500 dark:text-neutral-500 text-justify">
            ...
            <div className="relative pl-20 pr-4 md:pl-4 w-full">
              <h3 className="md:hidden block text-2xl mb-4 font-bold text-neutral-500 dark:text-neutral-500 text-justify">
                {item.title}
